...
## Code examples### curl```shellcurl -o listAllMetabolitePredicates.rq https://raw.githubusercontent.com/wikipathways/WikiPathways-SPARQL-book/master/sparql/listAllMetabolitePredicates.rq
